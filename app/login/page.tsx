      ...
      {!register ? (
        <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
          ...
          <div className="flex items-center justify-center mt-5">
            <button className="w-[100%] bg-blue-500 hover:bg-blue-700 text-white font-bold py-5 px-4 rounded focus:outline-none focus:shadow-outline" type="button" onClick={handleSignIn}>
              Sign In
            </button>
          </div>
        </form>
